...
import { Puzzle, Users, Star, ChevronLeft, ChevronRight, Filter, Grid3X3, List, Clock, TrendingUp, Flame, Zap } from 'lucide-react'
...
function TrendingContent() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-[#08080c] relative overflow-hidden">
      {/* Ambient Background Glow - Hot/Rose theme */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-rose-500/5 rounded-full blur-[100px] mix-blend-screen" />
        <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-orange-500/5 rounded-full blur-[100px] mix-blend-screen" />
      </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end gap-6 mb-8 animate-fade-in" style={{ animationDelay: '100ms' }}>
              <div className="flex-1">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-rose-500/10 text-rose-600 dark:text-rose-400 mb-4 border border-rose-500/20">
                  <Flame className="w-4 h-4 mr-2" />
                  Hot Right Now
                </div>
                <h1 className="text-4xl md:text-5xl font-bold text-foreground dark:text-white mb-4 tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-rose-500 to-orange-600 dark:from-rose-400 dark:to-orange-400">
                  Trending Puzzles
                </h1>
                <p className="text-lg text-muted-foreground dark:text-gray-400 max-w-2xl leading-relaxed">
                  See what everyone is playing right now. These puzzles are climbing the charts faster than any others.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 sticky top-20 z-20 bg-background/80 dark:bg-[#08080c]/80 backdrop-blur-xl p-4 rounded-2xl border border-border/50 dark:border-white/10 shadow-sm">
              <p className="text-muted-foreground text-sm">
                ...
                <span className="font-semibold text-foreground dark:text-white">{puzzles.length}</span> trending
              </p>
                ...
                {paginatedPuzzles.map((puzzle, index) => (
                  <Card 
                    ...
                    className={cn(
                      ...
                      "hover:shadow-xl dark:hover:shadow-2xl dark:hover:shadow-rose-500/10",
                      "hover:-translate-y-1 hover:border-rose-500/20 dark:hover:border-rose-500/30",
                      "animate-fade-in"
                    )}
                  ...
                  >
                    <CardHeader className="p-0 relative aspect-[4/3] overflow-hidden">
                      ...
                      <div className="absolute top-3 left-3">
                         <div className="flex items-center justify-center px-2 py-1 rounded-full text-xs font-bold text-white shadow-lg border border-white/20 backdrop-blur-md bg-rose-500">
                    ...
                    <CardContent className="p-4 relative">
                      ...
                      <div className="flex items-center justify-between text-sm text-muted-foreground dark:text-gray-400 mb-3">
                        <span className="flex items-center gap-1.5">
                          ...
                          {puzzle.plays_count.toLocaleString()} plays/hr
                        </span>
                      ...
                      <div className="flex-1 p-6 flex flex-col justify-between relative">
                        ...
                        <div className="flex gap-3 mt-6 sm:mt-0 pt-4 border-t border-border/50 dark:border-white/5">
                          ...
                          <Link href={`/play/${puzzle.id}`} className="flex-1 sm:flex-initial">
                            <Button size="sm" className="w-full sm:w-auto shadow-lg shadow-rose-500/20 bg-rose-600 hover:bg-rose-700 text-white">
                              <Flame className="w-4 h-4 mr-2" />
                              Play Hot Puzzle
                            </Button>
                          </Link>
...
export default function TrendingExplorePage() {
  return (
    <Suspense fallback={
