              ...
              <Card className="border-0 shadow-lg dark:bg-card dark:border dark:border-white/10">
                ...
                <CardContent className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-muted-foreground">Drag irregular pieces freely around the board</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-primary-subtle dark:bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-primary">2</span>
                    </div>
                    <p className="text-muted-foreground">Pieces auto-snap when edges align correctly</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-primary-subtle dark:bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-primary">3</span>
                    </div>
                    <p className="text-muted-foreground">Connected pieces move together as one unit</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-primary-subtle dark:bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-xs font-bold text-primary">4</span>
                    </div>
                    <p className="text-muted-foreground">Use ghost image or edge mode for hints</p>
                  </div>
                </CardContent>
              </Card>
